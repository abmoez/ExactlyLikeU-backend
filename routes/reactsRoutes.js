...
router.route("/agreedReacts/:postID").get(authController.protect,reactsController.getAgreedReactCount)
// get disagreed reacts GET :postID
router.route("/notAgreedReacts/:postID").get(authController.protect,reactsController.getNotAgreedReactCount)
